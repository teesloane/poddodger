...
(defn- obj->enclosure
  ...
  [^com.sun.syndication.feed.synd.SyndEnclosure e]
...
(defn- obj->content
  ...
  [^com.sun.syndication.feed.synd.SyndContent c]
  (map->content {:type  (.getType c)
                 :value (.getValue c)}))

(defn- obj->link
  "Create link struct from SyndLink"
  [^com.sun.syndication.feed.synd.SyndLink l]
...
(defn- obj->image
  ...
  [^com.sun.syndication.feed.synd.SyndImage i]
...
(defn- obj->entry
  ...
  [^com.sun.syndication.feed.synd.SyndEntry e]
...
(defn- obj->feed
  ...
  [^com.sun.syndication.feed.synd.SyndFeed f]
...
(defn- parse-internal
  [^com.sun.syndication.io.XmlReader xmlreader]
